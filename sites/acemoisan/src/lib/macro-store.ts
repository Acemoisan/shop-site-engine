...
export const SEED_FOODS: Food[] = [
  { id: "seed-chicken", name: "Chicken breast", serving: 100, unit: "g", kcal: 165, protein: 31, carbs: 0, fat: 3.6 },
  { id: "seed-rice", name: "White rice, cooked", serving: 100, unit: "g", kcal: 130, protein: 2.7, carbs: 28, fat: 0.3 },
  { id: "seed-egg", name: "Egg, large", serving: 1, unit: "item", kcal: 72, protein: 6.3, carbs: 0.4, fat: 4.8 },
  { id: "seed-oats", name: "Rolled oats, dry", serving: 40, unit: "g", kcal: 150, protein: 5, carbs: 27, fat: 3 },
  { id: "seed-banana", name: "Banana, medium", serving: 1, unit: "item", kcal: 105, protein: 1.3, carbs: 27, fat: 0.4 },
  { id: "seed-yogurt", name: "Greek yogurt, 2%", serving: 170, unit: "g", kcal: 145, protein: 20, carbs: 8, fat: 4 },
  { id: "seed-whey", name: "Whey protein", serving: 1, unit: "scoop", kcal: 120, protein: 24, carbs: 3, fat: 1.5 },
  { id: "seed-oliveoil", name: "Olive oil", serving: 1, unit: "tbsp", kcal: 119, protein: 0, carbs: 0, fat: 13.5 },
  { id: "seed-almonds", name: "Almonds", serving: 28, unit: "g", kcal: 164, protein: 6, carbs: 6, fat: 14 },
  { id: "seed-bread", name: "Bread, whole wheat", serving: 1, unit: "slice", kcal: 80, protein: 4, carbs: 14, fat: 1 },
];

export function defaultState(): State {
  return { goals: { ...DEFAULT_GOALS }, foods: SEED_FOODS.map((f) => ({ ...f })), log: {} };
}
...
export function loadState(): State {
  ...
  try {
    ...
    return {
      ...
      foods: Array.isArray(parsed.foods) && parsed.foods.length ? parsed.foods : defaultState().foods,
      log: parsed.log ?? {},
    };
  } catch {
    return defaultState();
